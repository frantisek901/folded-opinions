#### Main script for project with Guga on folded opinion, EXP8
#### In this version we just measure how well we replicate 'Black Pete' scenario and when.

## Encoding: windows-1250
## Created:  2023-06-29 Fran»esko
## Edited:   2023-08-04 Fran»esko
...
# Saving ------------------------------------------------------------------
  save(results, file = paste0("results8_seeds_", seed, ".RData"))
}
